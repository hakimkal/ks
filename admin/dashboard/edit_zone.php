<?php $pageName = 'Edit Governate';?>
<?php require('admin_top.php');?>
<?php 
$user= $mc->getZoneSMSArea($_GET['id']);
?>
<div class="row">
<br><br>
	<div class="col-md-8">
		<div class="widget">
			...
			<form action="<?php echo BASE_URL;?>/includes/app_controller.php" method="post">
				<input type="hidden" value="edit_zone_sms_area" name="_method" /> 
				<input type="hidden" value="<?php echo $user['id'];?>" name="ZoneSMSArea[id]" /> 
			
			<fieldset>
			<legend>Edit Governorate</legend>
				...
				<div class="main_popup1_1">
					<input type="text" name="ZoneSMSArea[name]" id="UserFirstname" value="<?php echo $user['name'];?>"
						class="main_input">
				</div>
				<div class="main_popup1_1">
				<p>Description</p>
