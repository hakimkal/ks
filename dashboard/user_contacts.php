...
<?php $pageName = 'KootSMS Customer   Contacts';?>
					...
					<div class="col-md-12">
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							<ul class="nav nav-tabs">
								...
								<li><a href="#tab_edit_account" data-toggle="tab"> Your Contacts</a></li>
							</ul>
						 ...
						 <div class="widget-content no-padding">
								<table class="table table-striped table-checkable table-hover">
								 ...
								 try {
									...
									$num_rows = $mc->db->get_user_contacts_count($conn,$_SESSION['User']['id']);
								 	...
								 	//$result = $stmt->fetchAll();
										$result = $mc->db->get_user_contacts($conn, $_SESSION['User']['id'], $pages->limit_start, $pages->limit_end);
								 	 foreach($result as $row) {
								 		$record=  "<tr><td>$row[1]</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td>";
								 		$record.= "<td class='align-center'><span class='btn-group'>
													<a href='send_sms.php?contact_id=".$row[0] ."  title='Send SMS' class='btn btn-xs bs-tooltip'><i class='icon-ok'></i></a>
