<?php $pageName = 'Send SMS to 1 Single Contact';?>
									...
									<form class="form-horizontal" action="<?php echo BASE_URL;?>/includes/app_controller.php" method="post"">
										<div class="col-md-12">
											<div class="widget">
												...
												<?php $Contact=$mc->getContact($_GET['contact_id']);
												//print_r($Contact);
												?>
													<h4>Message Pad</h4>
												</div>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8"><input type="text" name="SingleSms[sender]"   class="form-control"  ></div>
															</div>
															...
															<div class="form-group">
																...
																<input type="hidden" name="SingleSms[user_id]" value="<?php echo $_SESSION['User']['id'];?>" />
																<div class="col-md-8"><input type="text" name="SingleSms[phone]"   value="<?php echo $Contact['phone'];?>" class="form-control" required="required"></div>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8">
																	<textarea rows="6"  name="SingleSms[message]" class="form-control" cols="60"></textarea>
																</div>
															</div>
