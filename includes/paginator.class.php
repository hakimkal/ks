...
class Paginator{
	...
	public function display_jump_menu() {
		...
		return "<span class=\"paginate\">Page:</span><select class=\"paginate  select2\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&amp;ipp=$this->items_per_page$this->querystring';return false\">$option</select>\n";
	}
